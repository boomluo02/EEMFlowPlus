...
def train(args):
    ...
    elif(args.model_name == "ADMEEMFlow"):
        from model.ADMEEMFlow.ADMEEMFlow import ADMEEMFlow
        model = ADMEEMFlow(config=config, n_first_channels=5, out_mesh_size=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', '-model', default='ADMEEMFlow', type=str)
